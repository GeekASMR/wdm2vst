...
ENDPOINT_MINIPAIR SpeakerMiniports =
{
    ...
    CreateMiniportTopologySYSVAD,
    &SpeakerTopoMiniportFilterDescriptor1,
...
ENDPOINT_MINIPAIR MicInMiniports =
{
    ...
    NULL,                                   // optional template name
    CreateMiniportTopologySYSVAD,
    &MicInTopoMiniportFilterDescriptor1,
    0, NULL,                                // Interface properties
...
static
ENDPOINT_MINIPAIR MicInMiniports2 =
{
    eMicInDevice,
    L"TopologyMicIn2",
    NULL,
...
static
ENDPOINT_MINIPAIR MicInMiniports3 =
{
    eMicInDevice,
    L"TopologyMicIn3",
    NULL,
    CreateMiniportTopologySYSVAD,
    &MicInTopoMiniportFilterDescriptor3,
    0, NULL,
    L"WaveMicIn3",
    NULL,
    CreateMiniportWaveRTSYSVAD,
...
static
ENDPOINT_MINIPAIR MicInMiniports4 =
{
    eMicInDevice,
    L"TopologyMicIn4",
    NULL,
    CreateMiniportTopologySYSVAD,
    &MicInTopoMiniportFilterDescriptor4,
    0, NULL,
    L"WaveMicIn4",
    NULL,
    CreateMiniportWaveRTSYSVAD,
