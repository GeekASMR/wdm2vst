...
#define ExAllocateFromNPagedLookasideList(Lookaside) ExAllocatePool2(POOL_FLAG_NON_PAGED, (Lookaside)->L.Size, (Lookaside)->L.Tag)
#define ExFreeToNPagedLookasideList(Lookaside, Entry) ExFreePool(Entry)
