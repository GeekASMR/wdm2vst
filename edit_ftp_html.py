...
content = re.sub(r'v2\.1\.0 · Public Edition', r'V3.1.0 · Public Edition', content, flags=re.IGNORECASE)
content = re.sub(r'WDM2VST_v2\.1\.0_Setup\.exe', r'WDM2VST_Public_v3.1.0_Setup.exe', content, flags=re.IGNORECASE)

update_block = """    <div class="step"><div><h4>版本更新检测</h4><p>内置自动化版本侦测系统。当检测到新版本时，UI自动变形展现极客风格呼吸幻彩按钮，全自动重定向至最新下载地址。</p></div></div>
